...
#CONFIGURABLE
#########################################################################################################
authme1 = input (Fore.RED+"Please, set your "+Fore.BLACK+"Username : "+Fore.YELLOW+"")
if authme1 == "masonrapa":   #DELETE THE DEFAULT USER FOR NO LOGIN 
	passmasonrapa = input (Fore.RED+"Please, set your "+Fore.BLACK+"Password : "+Fore.YELLOW+"")
...
#########################################################################################################
		...
		while True:
			...
			os.system ("cls")
			print(Fore.CYAN+"´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´")
			print(Fore.CYAN+" ´´´´´´´´´´´´´´´´´´"+Fore.GREEN+"__"+Fore.YELLOW+"________"+Fore.CYAN+"´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´")
			print(Fore.CYAN+" ´´´´´´´´´´´´´´´´´"+Fore.YELLOW+"/|___"+Fore.GREEN+"______|"+Fore.CYAN+"´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´")
			print(Fore.CYAN+" ´´´´´´´´´´´´´´´´"+Fore.GREEN+"|. . .___"+Fore.YELLOW+"___|="+Fore.GREEN+"========="+Fore.YELLOW+"======0"+Fore.CYAN+"´´´´´´´´´´"+Fore.RED+"D"+Fore.CYAN+"´´´´´"+Fore.RED+"D"+Fore.CYAN+"´´´´"+Fore.RED+"D"+Fore.CYAN+"´´´´"+Fore.RED+"D"+Fore.CYAN+"´´´")
			print(Fore.CYAN+" ´´´´´´´´´´´´´´´ "+Fore.GREEN+"|______"+Fore.YELLOW+"_____|"+Fore.CYAN+"´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´")
			print(Fore.CYAN+" ´´´´´´´´"+Fore.YELLOW+"======="+Fore.GREEN+"==/. . . . . . "+Fore.YELLOW+"===="+Fore.GREEN+"=====_"+Fore.CYAN+"´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´")
			print(Fore.CYAN+" ´´´´´ "+Fore.YELLOW+"/  B Y : Z M A"+Fore.GREEN+" S O N R A P A . . .|"+Fore.CYAN+"´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´")
			print(Fore.CYAN+" ´´´´´"+Fore.GREEN+"/´´´´´´´´"+Fore.YELLOW+"´´´´´´´´"+Fore.GREEN+"´´´´´´´"+Fore.YELLOW+"´´´´´´´´"+Fore.GREEN+"´´´´|"+Fore.CYAN+"´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´")
			print(Fore.CYAN+" ´´´´´"+Fore.GREEN+"|´ O O O O O O O O O O O O O O O O O"+Fore.CYAN+"´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´´")
			print ()
			print (Fore.RED+"***"+Fore.RED+"**********************************"+Fore.CYAN+"           O")
			print (Fore.RED+"***"+Fore.BLUE+"  Hello "+Fore.YELLOW+""+(authme1)+"              "+Fore.RED+"***"+Fore.CYAN+"           B")
			print (Fore.RED+"***"+Fore.GREEN+"  Setea tu opcion              "+Fore.RED+"***"+Fore.CYAN+"           S")
			print (Fore.RED+"***"+Fore.RED+"**********************************"+Fore.CYAN+"           I")
			...
			print (Fore.RED+"***"+Fore.BLUE+"  10) "+(opt17)+"                   "+Fore.RED+"***")
			print (Fore.RED+"***"+Fore.BLUE+"  11) "+(opt10)+"                    "+Fore.RED+"***")
			print (Fore.RED+"***"+Fore.RED+"**********************************")
			x = input (Fore.BLACK+""+(opt16)+" [1/11] >> "+Fore.RED+"")
			if x == "11":
				exit()
			elif x == "1":
				...
				for ejecutar0 in subdomains0:
					try:
						...
						print (Fore.MAGENTA+"[ObsiTool] (Subdomain) >> "+Fore.CYAN+""+str(ejecutar0)+"."+str(victima0)+" >> "+Fore.BLACK+""+str(iphost0))
					except:
						pass
			elif x == "4":
				os.system ("cls")
				...
				os.system ("cls")
				print (Fore.RED+" 1) Spamm Commands ")
				...
				if pregun == "1":
					...
					pregop = input (Fore.GREEN+"Have The Server Essentials Plugin??? [YES/NO] >>> "+Fore.BLUE+"")
					if pregop == "YES":
						os.system ("cls")
					...
					os.system ("cls")
					usrknow = input (Fore.GREEN+"Set Your Nickname >>>  "+Fore.BLUE+"")
					os.system ("cls")
					...
					print (Fore.MAGENTA+"7) No Plugins ")
					print ()
				...
				os.system ("cls")
				print (Fore.RED+"Dont you know what song put in your griefing videos??? : O ")
				print ()
				print ()
				print (Fore.YELLOW+"Select a music type")
				print (Fore.RED+"1) SPANISH TRAP")
				print (Fore.RED+"2) ENGLISH TRAP")
				print (Fore.RED+"3) ELECTRO")
				print (Fore.RED+"4) NIGHTCORE")
				print ()
				musqu = input (Fore.GREEN+"Select Your Type [1-4] >>> "+Fore.BLUE+"")
				if musqu == "1":
					from random import seed
					from random import randint
					for _ in range(1):
